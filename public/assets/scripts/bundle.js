...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactfire = __webpack_require__(159);

	var _reactfire2 = _interopRequireDefault(_reactfire);

	var _Pearl = __webpack_require__(160);
	...
	var FirebaseRef = new _firebase2.default('https://torrid-fire-2043.firebaseio.com/');
	var FirebasePostsRef = FirebaseRef.child('posts');

	_reactDom2.default.render(_react2.default.createElement(_Pearl2.default, { FirebasePostsRef: FirebasePostsRef }), document.getElementById('app-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostList = __webpack_require__(161);

	var _PostList2 = _interopRequireDefault(_PostList);

	var _PostForm = __webpack_require__(162);

	var _PostForm2 = _interopRequireDefault(_PostForm);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Pearl = _react2.default.createClass({
		displayName: 'Pearl',
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_PostList2.default, { FirebasePostsRef: this.props.FirebasePostsRef }),
